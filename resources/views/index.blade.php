		...
		<div class="container">
			<div class="row no-gutters slider-text js-fullheight align-items-center" data-scrollax-parent="true">
				<div class="col-md-7 ftco-animate">
					...
					<h1 class="mb-4 text-uppercase">Website Informasi Seputar Pendakian</h1>
					<p class="caps">infopendakian.com</p>
				</div>
						...
						<div class="row">
							<div class="col-md-12 nav-link-wrap">
								<div class="nav nav-pills text-center" id="v-pills-tab" role="tablist" aria-orientation="vertical">
									{{-- <a class="nav-link active mr-md-1" id="v-pills-1-tab" data-toggle="pill" href="#v-pills-1" role="tab" aria-controls="v-pills-1" aria-selected="true">Cari Gunung</a> --}}

									{{-- <a class="nav-link" id="v-pills-2-tab" data-toggle="pill" href="#v-pills-2" role="tab" aria-controls="v-pills-2" aria-selected="false">Kota</a> --}}
											...
											<div class="row no-gutters">
                                                <div class="col-md d-flex">
													<div class="form-group p-4 border-0">
														<label for="#">Nama Gunung</label>
														<div class="form-field">
															<div class="icon"><span class="fa fa-search"></span></div>
															<input type="text" class="form-control" placeholder="Cari Gunung">
														</div>
													</div>
												</div>
												<div class="col-md d-flex">
												...
												<div class="col-md d-flex">
													<div class="form-group p-4">
														<label for="#">Tanggal Pendakian</label>
														<div class="form-field">
															<div class="icon"><span class="fa fa-calendar"></span></div>
															<input type="text" class="form-control checkin_date" placeholder="Tanggal Pendakian">
														</div>
													</div>
												</div>
												<div class="col-md d-flex">
													<div class="form-group p-4">
														...
														<div class="form-field">
															<div class="icon"><span class="fa fa-calendar"></span></div>
															<input type="text" class="form-control" placeholder="Ketinggian Maks">
														</div>
													</div>
												</div>
												<div class="col-md d-flex">
														...
														<div class="form-field">
															<div class="select-wrap">
																...
																<select name="" id="" class="form-control">
																	<option value="">Harga Tiket Maks</option>
